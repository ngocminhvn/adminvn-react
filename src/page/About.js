                                ...
                                <div className="col-12">
                                    <div className="section-breadcrumb">
                                        <ol className="breadcrumb">
                                            ...
                                            <li className="breadcrumb-item">
                                                <a href="//post/gioi-thieu.html">GIỚI THIỆU ADMIN VIETNAM</a>
                                            </li>
                                        </ol>
                                    </div>
                                </div>
                                ...
                                <div className="content">
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            <strong>&nbsp;<a href="/">Liên Hệ</a></strong>&nbsp;với người tố cáo hoặc Admin để được giải quyết
                                        </li>
                                    </ol>
                                    <h2>Lời muốn nói:</h2>
                                    <ul>
                                        ...
                                        <li><strong>Nguồn bài viết&nbsp;</strong>: <a href="/">CHECKSCAM.INFO&nbsp;</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
